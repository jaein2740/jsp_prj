...
<form name="frmGet" id="frmGet" action="http://192.168.10.72/jsp_prj/day0430/unique_name_process.jsp" 
method="get">
...
<form name="frmPost" id="frmPost"  action="../day0430/unique_name_process.jsp" 
method="post">
<ul><!-- autofocus="autofocus": 커서를 HTML Form Control 위치 시킬때 -->
