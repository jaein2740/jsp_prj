...
삼항 : ${i% 2 == 0 ? "짝수입니다" :'홀수입니다' }( ${i mod 2 eq 0 ?"짝수입니다" : '홀수입니다'})<br>

<!-- scope 객체가 가지고 있는 i값이 0~10 사이라면 "유효" 그렇지 않으면 "무효" 를 웹 브라우저에 출력-->
0~10 사이 유효 아니면 무효<br>
${ i gt -1 and i lt 11 ?'유효입니다' : '무효입니다' }<br>
