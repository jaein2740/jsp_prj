...
<div id="container">
	...
	<form action="member_frm_result.jsp" method="GET" name="frm" id="frm" >
		<table>
			<tr>
				<th>아이디</th>
				<td><input type="text" name="idInputText" readonly="readonly" id="idInputText"
			...
			<tr>
				<th>비밀번호</th>
				<td>
					<input type="password" class="inputBox" name="passInputText" style="width: 200px">
					비밀번호 확인
			...
			<tr>
				<th>이름</th>
				<td colspan="3"><input type="text" class="inputBox" name="nameInputText" style="width: 150px"></td>
			</tr>
			<tr>
				<th>생일</th>
				<td colspan="3"><input type="text" class="inputBox" name="birthInputText" style="width: 130px"></td>
			</tr>
			<tr>
				<th>연락처</th>
				<td colspan="3"><input type="text" class="inputBox" name="contactInputText" style="width: 130px"></td>
			</tr>
			<tr>
				<th>휴대폰</th>
				<td colspan="3"><input type="text" class="inputBox" name="callInputText" style="width: 130px">
					<input type="checkbox">수신</td>
			</tr>
			<tr>
				<th>이메일</th>
				<td colspan="3">
				<input type="text" class="inputBox" name="emailLeftInputText" style="width: 250px">@<input type="text"
					list="domainData"  class="inputBox" name="emailRightInputText" style="width: 160px"> 
			...
			<tr>
				<th>자기소개</th>
				<td>
				<textarea style="width: 500px;height: 100px" name="prInputText"></textarea>
