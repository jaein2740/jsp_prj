...
<div style="margin:0px auto; background:#FFFFFF url('images/member_success.png'); 
text-align: center;position: relative; width:606px ;height:378px; ">
<div style="position: absolute; top:170px; left:168px; font-size: 25px">
<strong><c:out value="${ param.name }"/>님 </strong>
</div>
<div style="position: absolute; top:270px; left:290px; font-size: 25px">
<a href="javascript:location.replace('http://192.168.10.72/jsp_prj/index.html')" class="btn btn-secondary btn-sm">메인으로</a>
</div>
</div>
</div>
</c:when>
...
<a href="http://192.168.10.72/jsp_prj/index.html">메인화면</a>
