...
<div id="container">
	...
	<form action="member_process.jsp" name="frm" id="frm" method="post">
		<table>
			<tr>
				<th>* 아이디</th>
				<td><input type="text" id="id" name="id" class="inputBox" maxlength="20" style="width:120px"> 
			...
			<tr>
				<th>연락처</th>
				<td colspan="3"><input type="text" class="inputBox" style="width:130px" name="tel2" maxlength="11"></td>
			</tr>
			<tr>
				<th>* 휴대폰</th><!-- 숫자만 쓰도록 제한해야함 -->
			...
			<tr>
				<th>자기소개</th>
				<td>
				<textarea style="width:500px;height:100px" id="selfIntro" name="intro"></textarea> 
