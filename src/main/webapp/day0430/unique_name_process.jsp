...
//txt=1&pass=23&file=login_box.png&hid=5월+1일+근로자의+날+안쉼.&flag=flag&sel=오라클&ta=321

//입력되는 문자열을 모두 encoding
//POST 방식에 한글을 입력받는 JSP에서 
request.setCharacterEncoding("UTF-8");

String txt=request.getParameter("txt");//<input type="text"
...
String ta=request.getParameter("ta");//<txtarea name="ta"

/* if("POST".equals(request.getMethod())){ //요청방식이 post 일 때
	//한글 처리
