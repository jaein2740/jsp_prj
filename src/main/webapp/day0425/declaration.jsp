...
<td style="width : 400px">점수</td>
</tr>
</thead>
<tbody>
<!-- 라디오 버튼을 생성하는 method
	사용법)
	createRadio("라디오이름","라디오인덱스",생성할 개수,checked를 설정할 라디오번호)
 -->
<%! 
	%>
...
<td><%=nameArr[i]%></td>
<td>
<%= MyUtil.createRadio("score", i, 10, 0) %>
<%-- <%
/* String checkedScore=""; */
...
<%-- <input type="radio" name="score<%= i %>" value="<%= score %>" <%=checkedScore %>><%= score %> --%>
<%-- <%}//end for %> --%>
</td>
</tr>
<% }//end for%>
