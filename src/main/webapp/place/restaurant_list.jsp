...
<th style="width:3f20px">메인 메뉴</th>
...
<img src="../login/images/login_fail.jpg" style="width: 60px"><br>
...
<td><a href ="rest_detail.jsp?num=${ restDTO.rest_num }&currentPage=${ rDTO.currentPage }${ queryStr }">
<c:out value="${ restDTO.restaurant }"/></a></td>
